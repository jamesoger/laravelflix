...
<?php endif; ?>
    <section>
        <?php $__currentLoopData = $films; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $film): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div>
                <a href="<?php echo e(route('films.show', ['id' => $film['id']])); ?>"><?php echo e($film->titre); ?></a>
                <img src="<?php echo e($film->poster); ?>" alt="film">
            </div>
...
<?php unset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4); ?>
<?php endif; ?>
<?php /**PATH C:\Users\james\OneDrive - CEGEP de Saint-JEROME\Module 4\Cadriciel web\cours02\cadw_tp1_OGER_james\tp1_films\resources\views/films/index.blade.php ENDPATH**/ ?>